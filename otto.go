...
import (
	...
	"github.com/Daniel-ccx/otto/file"
	"github.com/Daniel-ccx/otto/registry"
)
...
func (self Otto) GetAllVars() map[string]interface{} {
	return self.runtime.globalStash.getAllBindings()
}
